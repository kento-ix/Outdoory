...
export async function postExperience({ type, content, image }) {
    ...
    try {
        const res = await fetch(`${getApiBaseUrl()}/experiences?action=createExp`, {
            method: "POST",
            body: formData,
            headers: {
...
export async function getExperiences() {
    try {
        const res = await fetch(`${getApiBaseUrl()}/experiences?action=listExp`, {
            method: "GET",
            headers: {
...
export async function getUserExperiences() {
    try {
        const res = await fetch(`${getApiBaseUrl()}/experiences?action=userExp`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function deleteExperience(experienceId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/experiences?action=deleteExp&id=${experienceId}`, {
            method: "DELETE",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
