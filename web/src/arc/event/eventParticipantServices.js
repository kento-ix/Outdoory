...
export async function joinEvent(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=join`, {
            method: "POST",
            headers: {
...
export async function leaveEvent(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=leave&event_id=${eventId}`, {
            method: "DELETE",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function getEventParticipants(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=participants&event_id=${eventId}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function checkParticipationStatus(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=check&event_id=${eventId}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function getMyParticipatingEvents() {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=my_events`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function getEventDetail(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/eventParticipants?action=event_detail&event_id=${eventId}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
