...
export async function postEvent({ title, location, event_time, capacity, images }) {
    ...
    try {
        const res = await fetch(`${getApiBaseUrl()}/events?action=createEvent`, {
            method: "POST",
            body: formData,
            headers: {
...
export async function getEvents() {
    try {
        const res = await fetch(`${getApiBaseUrl()}/events?action=listEvent`, {
            method: "GET",
            headers: {
...
export async function getUserEvents() {
    try {
        const res = await fetch(`${getApiBaseUrl()}/events?action=userEvent`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export async function getEvent(eventId) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/events?action=get&id=${eventId}`, {
            method: "GET",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
...
export const deleteEvent = async (eventId) => {
    try {
        ...
        const response = await fetch(`${getApiBaseUrl()}/events?action=deleteEvent&event_id=${eventId}`, {
            method: 'DELETE',
            headers: {
...
export async function updateEvent(eventId, updateData) {
    try {
        const res = await fetch(`${getApiBaseUrl()}/events?action=update&event_id=${eventId}`, {
            method: "PUT",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${localStorage.getItem('token') || ''}`
